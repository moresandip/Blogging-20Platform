...
const categoryConfigs = [
  {
    ...
    icon: Code,
    description:
      "Latest trends in tech, programming, AI, and software development",
  ...
  },
  {
    ...
    icon: Palette,
    description:
      "UI/UX design, visual design principles, and creative processes",
...
export default function Categories() {
    ...
    const fetchCategoryData = async () => {
      try {
        ...
        if (response.ok) {
          ...
          const stats: CategoryStats[] = categoryConfigs.map(
            (categoryConfig) => {
              const categoryPosts = posts.filter(
                (post) => post.category === categoryConfig.name,
              );
          ...
          const featured = posts.sort((a, b) => b.likes - a.likes).slice(0, 6);
  ...
  const filteredCategories = categoryConfigs.filter(
    (category) =>
        ...
        <div className="container mx-auto max-w-6xl px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-4 mb-4">
              <div
                className={`w-16 h-16 rounded-full flex items-center justify-center text-2xl ${categoryConfig.color}`}
              >
      ...
      <div className="container mx-auto max-w-6xl px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Discover articles organized by topics you care about. From
            technology and design to lifestyle and business.
          </p>
        </div>
                ...
                <Card className="h-full hover:shadow-lg transition-all duration-200 hover:scale-105">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4 mb-4">
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center text-lg ${category.color}`}
                      >
                        {category.emoji}
                      </div>
                      <div className="flex-1">
