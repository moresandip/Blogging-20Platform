...
const featuredPost = {
  ...
  excerpt: "Explore the latest trends, technologies, and frameworks that are shaping the future of web development. From AI integration to serverless architecture...",
  author: {
    name: "Sarah Chen",
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Join a community of writers and readers passionate about sharing knowledge, 
              experiences, and insights that matter.
            </p>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-foreground mb-2">Featured Story</h2>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-2">Explore by Category</h2>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link to="/blogs" className="hover:text-foreground">Explore</Link></li>
                <li><Link to="/categories" className="hover:text-foreground">Categories</Link></li>
                <li><Link to="/create" className="hover:text-foreground">Write</Link></li>
              </ul>
            </div>
            <div>
